...
import org.android.turnaround.databinding.FragmentContactUsBinding
...
class ContactUsFragment : BottomSheetDialogFragment() {
    ...
    private fun setBottomSheetHeight() {
        ...
        binding.clBottomContact.layoutParams.height =
            (resources.displayMetrics.heightPixels * 0.51).toInt()
    }
}